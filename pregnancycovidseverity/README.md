...
CDC’s [Surveillance for Emerging Threats to Mothers and Babies Network (SET-NET)](https://www.cdc.gov/ncbddd/set-net/index.html) detects the effects of health threats on pregnant women and their babies by collecting data during pregnancy through childhood on pregnancies exposed to infectious diseases and uses evidence-based, actionable information to help save and improve the lives of mothers and babies. State, local, and territorial health departments work with CDC to identify exposures to infectious diseases during pregnancy and link them with health outcomes of mothers and babies. 
